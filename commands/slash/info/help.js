...
module.exports = {
    ...
    options: [
        {
            name: "commande",
            description: "Obtenir des infos sur une commande spécifique",
    ...
    execute: async (client, interaction) => {
        ...
        if (input) {
            ...
            if (!cmd) return interaction.editReply({ content: "❌ Commande inconnue." });
        ...
        const msg = await interaction.editReply({ embeds: [mainEmbed], components: [selectMenu], fetchReply: true });
